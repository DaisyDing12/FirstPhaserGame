...
var ledge = platforms.create(100, 50, 'ground');
...
star.body.bounce.y = 0.7 + Mat.random() * 0.2;
}
...
if (cursors.up.isDown && player.body.touchng.down && hitPlatform)
{
